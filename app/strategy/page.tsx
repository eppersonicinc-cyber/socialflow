...
export default function AIStrategyEngine() {
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col bg-[#1e0f24] dark group/design-root overflow-x-hidden">
            ...
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#40204b] px-4 md:px-10 py-3">
              <div className="flex items-center gap-4 text-white">
                ...
                <h2 className="text-white text-lg font-bold leading-tight tracking-[-0.015em]">
                  AI Strategy Engine <span className="ml-2 text-[10px] bg-primary px-1.5 py-0.5 rounded text-white uppercase tracking-widest">Prod</span>
                </h2>
              </div>
              <div className="flex flex-1 justify-end gap-4 md:gap-8">
                <label className="hidden md:flex flex-col min-w-40 !h-10 max-w-64">
                  <div className="flex w-full flex-1 items-stretch rounded-xl h-full">
                    ...
                    <input
                      className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-white focus:outline-0 focus:ring-0 border-none bg-[#40204b] focus:border-none h-full placeholder:text-[#bd8dce] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
                ...
                <div
                  ...
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCoaOWHvDElc_-VENieHeT4nRKnpFFfvHC8tL5QAmZW9OKGO4uQ9wTzfsP1EbBLLyPaqo1ObHLUUjxrScQ09mu4e85qfybpXVCKzcmqiMp98FCPABoUNRJHPcKcn2ybgZqsZQGF4D-YaB4oOMiaVbuobFVj6ztcjstS2A75wy8PxSVIV0cWpC__GGfEMJzVoF6-N6BNEV6Nk6SW9wt3cBhnY6ACX-ymCJ3W7kot2nP7YN6LhoV2K8gwEuQEt6uCuin5j7x5GwT8ocBI")' }}
                ></div>
              </div>
            </header>
                  ...
                  <div className="p-4 bg-[#1a0c1f] border-t border-[#40204b]">
                    <div className="flex gap-3">
                      <div className="flex-1 relative">
                        <input
                          className="w-full bg-[#0d070f] border border-[#40204b] rounded-xl px-4 py-3 text-white focus:ring-1 focus:ring-primary focus:border-primary placeholder:text-[#6b427a] font-mono"
                          placeholder="Inject command or prompt suffix..."
                          type="text"
                        />
                    ...
                    <div className="relative h-32 w-full bg-[#1a0c1f] rounded-lg border border-[#40204b] flex items-center justify-center">
                      ...
                      <div className="z-10 flex gap-4 items-center">
                        ...
                        <div className="size-10 rounded bg-[#1a0c1f] flex items-center justify-center border border-[#40204b]">
                          <span className="material-symbols-outlined text-[#bd8dce] text-sm">publish</span>
                        </div>
                      </div>
                    </div>
            ...
            <footer className="mt-auto border-t border-[#40204b] px-10 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[#bd8dce] text-xs font-mono">
              <div className="flex items-center gap-6">
                <span className="flex items-center gap-2">
                  <span className="size-2 bg-[#0bda7a] rounded-full"></span> SYSTEM ONLINE
                </span>
