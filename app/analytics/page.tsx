...
export default function AnalyticsCommand() {
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col bg-[#221311] dark group/design-root overflow-x-hidden">
            ...
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#472724] px-10 py-3">
              ...
              <div className="flex flex-1 justify-end gap-8">
                ...
                <div
                  ...
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC9gKWL7PGHEAyTRYear1BE_9b6ALmuPCGH7Jf6XNpVTgvjVo2OeU9AAKNNMRYBgNbTKhx9L6gQ6Tlkcp-Zau2klnwEDFlXYiNIAuAEk5oTN1BBQR4RDUp3HyPxXfYjJUJWvhSabXNNPzU0_OLEhr-i4cu4U-u27d79CsYd4YIksguU2JqBbHeg7UqJcziErsJLKF8dFcw3xwZ89iaarD8MWMBxYmD0Z66_0_vJ3aJOr9lkpZ5Owv3a7dkhSEvC3VU-DL4xRBQFHwz_")' }}
                ></div>
              </div>
            </header>
                  ...
                  <div className="col-span-1 md:col-span-2 bg-[#2d1a18] border border-[#472724] rounded-2xl p-6">
                    ...
                    <div className="w-full h-32">
                      <svg fill="none" height="100%" preserveAspectRatio="none" viewBox="0 0 400 100" width="100%" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                          <linearGradient gradientUnits="userSpaceOnUse" id="main_grad" x1="0" x2="0" y1="0" y2="100">
